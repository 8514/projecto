...
console.log(display_student_array);  
document.getElementById("disply_name_with_commas").innerHTML=display_student_array;
...
document.getElementById("disply_name_without_commas").innerHTML=remove_commas;